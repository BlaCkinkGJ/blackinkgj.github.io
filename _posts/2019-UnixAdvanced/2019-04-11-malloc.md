...
이렇게 할당된 cptr은 0번지를 먼저 가지고 있습니다. 이 경우 ++cptr을 해주변 1번지를 가지고 iptr에 의해서 4 바이트가 읽어지면서 1번지 ~ 4번지를 가져오도록 합니다. 이런 경우에 alignment가 맞지 않게 되고, SIGBUS가 날라가게 됩니다. 이런 문제도 조심을 해야 합니다.
